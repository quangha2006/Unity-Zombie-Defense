...
Shader "Toony Colors Pro 2/User/Dissolve_Effect"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		// Custom Material Properties
		 _DissolveValue1 ("Dissolve Value", Range(0,1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings Vertex(Attributes input)
			{
				...
				worldPos.xyz = ( worldPos.xyz + pow(_DissolveValue1, 2) * input.vertex.y * float3(0,1,0) );
...
/* TCP_DATA u config(unity:"6000.0.47f1";ver:"2.9.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","NO_RAMP","DISSOLVE","DISSOLVE_CLIP","DISSOLVE_GRADIENT","DISSOLVE_SHADER_FEATURE","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[,,,,,,sp(name:"Dissolve Map";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:True;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:True;def:"gray";locked_uv:False;uv:6;cc:1;chan:"R";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Triplanar;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_DissolveMap";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"2898f023-96f4-45ac-9e25-91b059d4eb82";op:Multiply;lbl:"Map";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"Dissolve Value";imps:list[imp_ct(lct:"_DissolveValue1";cc:1;chan:"X";avchan:"X";guid:"86d08fc5-12f7-467d-8176-2b2974c08e98";op:Multiply;lbl:"Value";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,sp(name:"Vertex Position World";imps:list[imp_hook(guid:"d0eb2b48-4e85-4065-8e4d-94e1b7447b69";op:Multiply;lbl:"worldPos.xyz";gpu_inst:False;locked:False;impl_index:0),imp_customcode(prepend_type:Disabled;prepend_code:"";prepend_file:"";prepend_file_block:"";preprend_params:dict[];code:"+ pow({3}, 2) * input.vertex.y * float3(0,1,0)";guid:"e228eac3-a006-44e8-94be-38c455292631";op:Multiply;lbl:"Vertex Position World";gpu_inst:False;locked:False;impl_index:-1),imp_ct(lct:"_DissolveValue1";cc:3;chan:"XXX";avchan:"X";guid:"af27203c-29a7-429e-87d6-e6d740f6dd59";op:Multiply;lbl:"Vertex Position World";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[ct(cimp:imp_mp_range(def:1;min:0;max:1;prop:"_DissolveValue1";md:"";gbv:False;custom:True;refs:"Dissolve Value, Vertex Position (World Space)";pnlock:False;guid:"1b4bba6f-196a-4cb5-b89f-838e7df26bec";op:Multiply;lbl:"Dissolve Value";gpu_inst:False;locked:False;impl_index:-1);exp:True;uv_exp:False;imp_lbl:"Range")];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH e0181c0bc000437afcff2ecf615f4b0e */
